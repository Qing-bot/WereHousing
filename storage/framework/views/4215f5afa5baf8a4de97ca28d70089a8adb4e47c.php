            ...
            <div class="w-[100%] flex flex-wrap items-center justify-between mx-4 p-3">
                ...
                <div class="flex w-[25%]" id="navbar-default justify-end items-center overflow-">
                    <ul class="font-medium flex p-1 border border-gray-100 rounded-lg">
                        <li>
                        <a href="<?php echo e(route('index_home')); ?>" class="block py-2 px-2 text-gray-600 rounded" aria-current="page">Home</a>
                        </li>
                        <li>
                        <a href="<?php echo e(route('index_profile')); ?>" class="block py-2 px-2 text-gray-600 rounded" aria-current="page">Profile</a>
                        </li>
                        <li>
                        <a href="#" class="block py-2 px-2 text-gray-600 rounded" aria-current="page">Profile</a>
                        </li>
                        <li>
...
<?php /**PATH C:\Users\NATHANIEL ORION\Downloads\Werehousing\resources\views/layouts/navbar.blade.php ENDPATH**/ ?>